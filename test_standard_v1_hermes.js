...
async function runTest() {
    try {
        ...
        console.log(`Retrying PAY_PAGE with Standard Sandbox (V1 HERMES): ${MERCHANT_ID}`);
        ...
        const payload = {
            ...
            amount: 10000,
            redirectUrl: "https://indritafabrics.com/api/payment/callback",
            redirectMode: "POST",
            callbackUrl: "https://indritafabrics.com/webhook/phonepe",

        ...
        <main style={{ padding: '2rem 1.5rem', maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div className="policy-content" style={{ fontFamily: 'Inter, sans-serif', lineHeight: '1.6', color: '#2C1B10' }}>
                ...
                <p style={{ marginBottom: '1rem' }}>
                    INDRITA FABRICS offers customers the option of Cash on Delivery (COD) as well as prepaid payment methods. 
                    Customers may choose their preferred payment option while placing an order. Availability of Cash on Delivery 
                    depends on serviceable locations and may be subject to verification before confirmation.
                </p>
